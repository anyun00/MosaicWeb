...
<body>
	...
	<div id="reply" class="panel panel-info">
		<div class="panel-heading">
			<button id="replylist" class="btn btn-info">댓글 조회</button>
		</div>
		<div class="panel-body">
...
// 			var str = JSON.stringify(pageMaker);
			...
			pageMaker.prev = true;
			if(pageMaker.prev){
				str	+= '<li><a href="#">' + (pageMaker.startPage-1) + "prev</a></href>";
			}
...
// 			for(var i = pageMaker.startPage; i<=pageMaker.endPage; i++ ){
			...
			pageMaker.next = true;
			if(pageMaker.next){
				str	+= '<li><a href="#">' + (pageMaker.endPage+1) + "next</a></href>";
			}
