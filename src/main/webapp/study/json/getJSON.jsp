...
<body>
	...
	<hr>
	<h1>AJAX (Asynchronous Javascript And XML)비동기 자바스크립트 데이타 통신기술</h1>
	...
	<script type="text/javascript">
		...
		$('button').eq(0).on('click',function() {
					...
					$.getJSON("/study/json/dept.json", function(data) {
						...
						var li = '<li class="list-group-item list-group-item">' + data.deptno
								+ "," + data.dname + "," + data.loc + "</li>";
		...
		$('button').eq(1).on( 'click', function() {
					...
					$.getJSON("/study/json/depts.json", function(data) {
						...
						lis += '<li class="list-group-item">' + data[i].deptno + "," + data[i].dname + "," + data[i].loc + "</li>";
						}
						$('#result').html(lis);
					});
				});
